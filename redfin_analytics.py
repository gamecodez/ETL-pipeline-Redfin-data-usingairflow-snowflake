...
# s3 buckets
target_bucket_name = 'redfin-transform-zone-eris'
...
with DAG('redfin_analytics_dag',
        ...
        transform_redfin_data_and_upload_to_s3 = PythonOperator(
        ...
        load_raw_data_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://store-raw-data-eris',
        )

        extract_redfin_data >> transform_redfin_data_and_upload_to_s3 >> load_raw_data_to_s3
